...
class conversiontracking extends Module
{
	...
	public function __construct()
	{
		...
		$this->description = $this->l('Include and manage tracking scripts for various marketing services');

		$this->confirmUninstall = $this->l('Conversion tracking scripts will be removed. Are you sure you want to uninstall?');
	}
	...
	{
		Configuration::updateValue('conversiontracking_LIVE_MODE', false);
	...
	{
		Configuration::deleteByName('conversiontracking_LIVE_MODE');
	...
	protected function renderForm()
	{
		...
		$helper->submit_action = 'submitconversiontrackingModule';
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'name' => 'conversiontracking_LIVE_MODE',
						'is_bool' => true,
					...
					array(
						...
						'name' => 'conversiontracking_ACCOUNT_EMAIL',
						'label' => $this->l('Email'),
					),
					array(
						'type' => 'password',
						'name' => 'conversiontracking_ACCOUNT_PASSWORD',
	...
	{
		return array(
			'conversiontracking_LIVE_MODE' => Configuration::get('conversiontracking_LIVE_MODE', true),
			'conversiontracking_ACCOUNT_EMAIL' => Configuration::get('conversiontracking_ACCOUNT_EMAIL', 'contact@prestashop.com'),
			'conversiontracking_ACCOUNT_PASSWORD' => Configuration::get('conversiontracking_ACCOUNT_PASSWORD', null),
		);
	}
